...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 3.7;
  ...
  public static final double wheelRadiusMeters = Units.inchesToMeters(1.8);
  public static final double driveMotorReduction = 5.14; // Protolone Drive Gearing
  ...
  public static final double turnMotorReduction = 12.8; // Protolone turn gearing
